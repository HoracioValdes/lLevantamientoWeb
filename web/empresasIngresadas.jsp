        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s10 offset-s1">
                    <h2><b>Consulta de Registros de Empresas</b></h2>
                    <p class="flow-text" align="justify">En esta ventana puede seleccionar el registro de una empresa para eliminarla o modificar el tipo de contrato.</p>
                ...
                <div class="col s10 offset-s1"> 
                    <table class="bordered">
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.empresasBuscadas}" var="e">
                                <tr>
                                    <td>${e.nombre_puerto}</td>
                                    <td>${e.nombre_agencia}</td>
                                    <td>${e.tipo_contrato}</td>
                                    <td>
                                        <a class="btn-floating red" href="empresaBuscada.do?rut_socio=${e.rut_socio}&rut_empresa=${e.rut_empresa}&id_puerto=${e.id_puerto}">
