<%-- 
    Document   : registroEncontrado
    Created on : 27-04-2018, 16:28:34
    Author     : Horacio
--%>

<%@page import="cl.modelo.Registro"%>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 card-panel red lighten-4">
                    ...
                    <br/>
                    <p class="flow-text"><b>¿Es válido el registro?: </b><%=registro.getValido()%></p>
                    <p class="flow-text"><b>Nombre del Trabajador: </b><%=registro.getNombre()%></p>
                    <p class="flow-text"><b>Rut del Trabajador: </b><%=registro.getRut()%></p>
                    <p class="flow-text"><b>Sindicato del Trabajador: </b><%=registro.getSindicato()%></p>
                    <p class="flow-text"><b>¿Posee información de 'Trabajo en Puerto'?: </b><%=registro.getTrabaja()%></p>
                    <p class="flow-text"><b>¿Posee información de 'Pertenencia a Empresa'?: </b><%=registro.getPertenece()%></p>
                    <br/>
                </div>
            </div>
