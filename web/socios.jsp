        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s10 offset-s1">
                    ...
                    <p class="flow-text" align="justify">En este formulario debe ingresar, modificar o eliminar los datos del trabajador.</p>
                    <p class="flow-text" align="justify">También puede ingresar el rut y presionar el botón 'BUSCAR' para consultar los datos de un socio ya ingresado.</p>
                </div>
            </div>
            ...
            <div class="row">
                <form class="col s10 offset-s1" action="socios.do?id_ingreso=${sessionScope.ingreso.id}" method="post">
                    ...
                    <br/>
                    <p class="flow-text">2. ¿Cuál es su rut?</p>
                    <label>Rut</label>
                    <div class="row">
                        <div class="input-field col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <label for="miembrosHogar">Integrantes del hogar</label>
                        </div>
                    </div>
                    ...
                    <label>¿Trabajo en más de un puerto el último año?</label>
                    <div class="row">
                        <div class="input-field col s6">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input name="optIsapre" type="radio" id="test77" value="1"/>
                            <label for="test77">Sí</label>
                        </div>
                        <div class="input-field col s6">
                            <input name="optIsapre" type="radio" id="test78" value="0"/>
                            <label for="test78">No</label>
                        </div>
                    </div>
                    ...
                    <br/>
                    <p class="flow-text" align="justify">- Una vez ingresado el socio, deberá ingresar la información de todos los puertos en donde trabaja.</p>
                    <p class="flow-text" align="justify">- Puede acceder a ese formulario de ingreso en el menú de navegación.</p>
                    <br/>
                    <div class="row">
                        <button class="btn waves-effect waves-light" type="submit" name="action" onclick="return probando();" value="ingresar">Ingresar<i class="material-icons right">send</i></button>
