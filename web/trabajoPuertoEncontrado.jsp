...
<%@page import="cl.modelo.TrabajoBuscado"%>
...
<html>
    ...
    <%
        ...
        TrabajoBuscado trabajoBuscado = (TrabajoBuscado) request.getAttribute("trabajoBuscado");
    %>
    <body>
        <div class="container">
            <% if (ingreso != null) {%>
            ...
            <div class="row">
                <div class="col s10 offset-s1">
                    ...
                    <p class="flow-text" align="justify">En este formulario puede modificar o eliminar los datos del trabajo portuario de algún trabajador.</p>
                    <p class="flow-text" align="justify">Si desea modificar los datos, deberá volver a ingresarlos en el formulario.</p>
            ...
            <div class="row"> 
                <form class="col s10 offset-s1" name="form" action="puertos.do?id_ingreso=${sessionScope.ingreso.id}" method="post">
                    <div class="col s12 card-panel red lighten-4">
                        ...
                        <br/>
                        <p class="flow-text"><b>Rut: </b><%=trabajoBuscado.getRut_socio()%></p>
                        <p class="flow-text"><b>Nombre: </b><%=trabajoBuscado.getNombre_socio()%></p>
                        <p class="flow-text"><b>Puerto: </b><%=trabajoBuscado.getPuerto()%></p>
                        <p class="flow-text"><b>Trabajó en enero: </b><%=trabajoBuscado.getEnero()%></p>
                        <p class="flow-text"><b>Trabajó en febrero: </b><%=trabajoBuscado.getFebrero()%></p>
                        <p class="flow-text"><b>Trabajó en marzo: </b><%=trabajoBuscado.getMarzo()%></p>
                        <p class="flow-text"><b>Trabajó en abril: </b><%=trabajoBuscado.getAbril()%></p>
                        <p class="flow-text"><b>Trabajó en mayo: </b><%=trabajoBuscado.getMayo()%></p>
                        <p class="flow-text"><b>Trabajó en junio: </b><%=trabajoBuscado.getJunio()%></p>
                        <p class="flow-text"><b>Trabajó en julio: </b><%=trabajoBuscado.getJulio()%></p>
                        <p class="flow-text"><b>Trabajó en agosto: </b><%=trabajoBuscado.getAgosto()%></p>
                        <p class="flow-text"><b>Trabajó en septiembre: </b><%=trabajoBuscado.getSeptiembre()%></p>
                        <p class="flow-text"><b>Trabajó en octubre: </b><%=trabajoBuscado.getOctubre()%></p>
                        <p class="flow-text"><b>Trabajó en noviembre: </b><%=trabajoBuscado.getNoviembre()%></p>
                        <p class="flow-text"><b>Trabajó en diciembre: </b><%=trabajoBuscado.getDiciembre()%></p>
                        <p class="flow-text"><b>Turnos realizados: </b><%=trabajoBuscado.getTurnos()%></p>
                        <p class="flow-text"><b>Sección de trabajo: </b><%=trabajoBuscado.getSeccion()%></p>
                        <p class="flow-text"><b>Función: </b><%=trabajoBuscado.getFuncion()%></p>
                        <p class="flow-text"><b>Sufrió un accidente: </b><%=trabajoBuscado.getAccidente()%></p>
                        <br/>
                    </div>
                    <br/>
                    <p class="flow-text">&nbsp;</p>
                    ...
                    <p class="flow-text">2. Indique nuevamente el rut del trabajador (no editable)</p>
                    <label>Rut</label>
                    <div class="row">
                        <div class="input-field col s12">
                            <input name="txtRut" id="rut" type="text" class="validate" value="<%=trabajoBuscado.getRut_socio()%>" maxlength="12" readonly="true">
                        </div>
                    ...
                    <p class="flow-text">21. ¿En qué puerto trabaja? (no editable)</p>
                    <div class="row">
                        <div class="input-field col s12">
                            <select name="cboPuerto" id="cboPuerto">
                                <option value="<%=trabajoBuscado.getId_puerto()%>" selected="true"><%=trabajoBuscado.getPuerto()%></option>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <button class="btn waves-effect waves-light" type="submit" name="action" onclick="return probandoSiete();" value="modificar">Modificar<i class="material-icons right">autorenew</i></button>
                        <button class="btn waves-effect waves-light" type="submit" name="action" onclick="return probandoOcho();" value="eliminar">Eliminar<i class="material-icons right">clear</i></button>
                    </div>
